...
while ($data = mysqli_fetch_assoc($query)) {
  ...
  $html .= '		<tr>
                  ...
                  <td width="65" align="center">' . date('d-m-Y', strtotime($data['tanggal_upload'])) . '</td>
                  <td width="60" align="center">' . $data['jenis_pilot'] . '</td>
                  <td width="120">' . $data['ip'] . '</td>
                  <td width="60" align="center">' . $data['perangkat'] . '</td>
                  <td width="140">' . $data['keterangan'] . '</td>
                  <td width="100">' . $data['domain'] . '</td>
...
$html .= '    </tbody>
          ...
          <div class="text-right mt-5">Bondowoso, ' . tanggal_indo(date('Y-m-d')) . '</div>
        </body>
        </html>';
